...
class sfWebDebugPanelConfig extends sfWebDebugPanel
{
  ...
  protected function formatArrayAsHtml($id, $values)
  {
    ...
    <div id="sfWebDebug'.$id.'" style="display: none"><pre>'.htmlspecialchars(\Symfony\Component\Yaml\Yaml::dump(sfDebug::removeObjects($values)), ENT_QUOTES, sfConfig::get('sf_charset')).'</pre></div>
    ';
  }
}
